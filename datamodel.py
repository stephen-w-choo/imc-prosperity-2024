...
class TradingState(object):
    ...
    def __init__(self,
        ...
        self.own_trades = own_trades # the trades the algorithm itself has done since the last state
        self.market_trades = market_trades # trades from other market participants since last state
        self.position = position # the current position held in each product

...
training_data_path = f"data/log_data.csv"
test_data_path = f"data/log_data.csv"
...
mid_prices: pd.DataFrame = training_data[training_data["product"] == PRODUCT]["mid_price"].to_frame()
test_mid_prices: pd.DataFrame = test_data[test_data["product"] == PRODUCT]["mid_price"].to_frame()
